...
function dhma_overview_search_widget() {
    return '<div class="sb_widget widget_rss">'
            ...
            . '&nbsp;<section><h4>Activity:</h4> <div id="activity-list-core" style="width: 250px;"></div></section>'
            ...
            . '&nbsp;<section><h4>Activity:</h4> <div id="activity-list" style="width: 250px;"></div></section>'
